...
Recursos Humanos, Dirección de Tecnologias de la Informacion, Almacen y otros procesos administrativos</h4> <br>
 -->
  ...
  <div class="container">
  <button type="button" class="btn btn-default" onClick="window.location.href='logout.php'">Cerrar Sesión</button>
</div>
  ...
  <div class="row">
    <div class="col-lg-3 col-sm-8">
      <div class="circle-tile ">
        <a href="<?php echo $row['ruta_sistema'];?>/<?php echo $row['nombre_link'];?>" data-toggle="tooltip" title="Pertmitido tu ingreso"><div class="circle-tile-heading dark-blue"><i class="fa fa-unlock fa-fw fa-3x"></i></div></a>
        <div class="circle-tile-content dark-blue">
          ...
          <a class="circle-tile-footer" href="<?php echo $row['ruta_sistema'];?>/<?php echo $row['nombre_link'];?>">Ingresar <i class="fa fa-chevron-circle-right"></i></a>
        </div>
      </div>
    </div>
	<script>
...
<div class="container">
  <div class="row">
    <div class="col-lg-3 col-sm-8">
      <div class="circle-tile ">
        <a href="#" data-toggle="tooltip" title="NO TIENES LOS SUFICIENTES PERMISOS PARA INGRESAR A ESTE SISTEMA"><div class="circle-tile-heading dark-blue"><i class="fa fa-lock fa-fw fa-3x"></i></div></a>
        <div class="circle-tile-content dark-blue">
          <div class="circle-tile-description text-faded"><?php echo $row['nombre_sys']?></div>
          <div class="circle-tile-number text-faded ">No asignado</div>
          <label class="circle-tile-footer" <strike>Ingresar</Strike> <i class="fa fa-chevron-circle-right"></i></label>
        </div>
      </div>
    </div>
