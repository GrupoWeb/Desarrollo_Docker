<body>
	<form action="#" method="POST" enctype="multipart/form-data" name="form1" style = "position: relative;  width:80%;  display: inline-block;">
		...
		<div style = "pisition: relative;  width:100%;  display: inline-block;">
			<label id = "Agraga_Contenido" class="Agregar"><i class="fa fa-plus-square" style="font-size:48px;color:hsl(120,60%,50%);">Agregar Linea</i></label>
		</div>
		</form>
    <style>
...
<script type='text/javascript' src="js/jquery.min.js"></script>
	<script type='text/javascript' src="js/jquery.dataTables.min.js"></script>
	 <link rel="stylesheet" type="text/css" href="css/jquery.dataTables.min.css">
		<script>
			$.ajax({ url: 'PHP/MCarga_Linea_Vehiculos.php',
			...
			$(document).ready(function(){
				$("#Agraga_Contenido").click(function(){
					$("#cont").load("Formulario_Ingreso_Linea_Vehiculo.php");
				});
          	});
		</script>
</body>