	...
	<script>
			...
			$(document).ready(function(){
                    ...
                    $(".envia").click(function(){
						...
						//var cantidad = $('.boton').parents("tr").find('#cantidad').val();
						 //var name = $('.boton').parents("tr").find("#paso").val();
				         	...
				         	success: function(data) {
		                		...
		                		$.ajax({
		                			...
		                			success: function(data){
		                				if(data == "true")
		                				{
											alert("El vehiculo se encuentra en reserba de combustible ... Se le dara la opcion de asignarle un vale para combustible");
