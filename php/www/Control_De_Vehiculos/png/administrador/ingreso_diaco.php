...
<form action="guardarsolicitud_diaco.php" method="post" enctype="multipart/form-data" name="form1">
  
<header id="header" class="info">
<h2>Ingreso de Expedientes DIACO </h2>

<p>
  <? include("consulta/fecha.php");  ?>
</p>
<p><img src="../logos_expe/diaco.jpg" width="77" height="81"></p>
</header>
...
?>
  ...
  <br>
  <br>
  <span class="notranslate      "><strong>Numero de  DIACO: </strong>
  <input type="text" name="prp" size="10"  value="" required="required">
  </span></label>
