...
<body bgcolor="#CCCCCC">
<p>&nbsp;</p>
<p align="center" class="Estilo1">Mantenimineto de empresa </p>
...
<table width="800" border="0" align="center">
  <tr>
    <td width="168">Nombre empresa:</td>
    <td width="172"><input name="nombre1" type="text" value=""   /> </td>
    <td width="107">Nit:</td>
    <td width="223"><input type="text" name="nit" value=""  /></td>
    <td width="107">Sector Emprea:</td>
    <td width="223"><input type="text" name="secemp" value=""></td>
