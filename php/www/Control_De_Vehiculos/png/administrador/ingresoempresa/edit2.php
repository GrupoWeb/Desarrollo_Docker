...
$sql = "select nombre_empresa from dbo.empresa where id_empresa='$cor' and activo = 1";
...
{ 
 $sqlz3 = "update 
dbo.empresa  set nombre_empresa= '$nombre' , nits='$apellido' ,id_sector = '$secem' where id_empresa = '$cor'";
