...
<form action="guardarsolicitud_polic.php" method="post" enctype="multipart/form-data" name="form1">
  
<header id="header" class="info">
<h2>Ingreso de Expedientes Ministerio de Defensa </h2>

<p>
  <? include("consulta/fecha.php");  ?>
</p>
<p><img src="../logos_expe/mineco.png" width="184" height="85"></p>
</header>
