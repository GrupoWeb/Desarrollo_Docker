...
<?
		 ...
		 $año = date ('Y');
			...
			$sql = " select  
	  ex.Fecha_ingreso, us.nombre,us.apellido,  ex.comentario,ex.Id_expedienteudaf as idf, es.nombre as p , es.apellido as a, spt.Estado as nota, spt.paht as th
	 from  usuario as us inner join expediente_udaf as ex  on us.id_usuario = ex.Id_usuario  
	 ...
	 inner join estado as est on ex.id_estado=est.Id_estado inner join estado as spt on ex.id_recibido = spt.Id_estado where est.codigo_estado = 1 and ex.id_usuario= '$uen'  order by  ex.Id_expedienteudaf desc";
$stmt = sqlsrv_query( $conn, $sql );
...
echo "<td> <a href='../versolicitududaf/versolicitud.php?ex=$t' >  <img src='images/lupas.png' width='24' height='22'> </td>";
echo "<td><a href='recibido.php?ex=$t' >  <img src='images/$thr' width='24' height='22'> </td>";
