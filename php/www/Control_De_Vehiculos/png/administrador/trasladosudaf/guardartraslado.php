...
echo "depet",	$aa= $_REQUEST['dept2'],"<br>"; 
echo "usuario",	$bb= $_REQUEST['usuarip'],"<br>" ; 
echo "comentario",	$cc= $_REQUEST['coment2'],"<br>";
echo "estado",	 $dd= $_REQUEST['estab2'],"<br>";
echo "id",	$ee= $_REQUEST['mc'],"<br>";
echo "sector",	$sectorexp = $_REQUEST['sectorex'],"<br>" ;
	
	
    $sqlz1 = " select id_usuario, id_estado, Id_expedienteudaf from expediente_udaf where Id_expedienteudaf = '$ee' ";
...
sqlsrv_free_stmt( $stmt);		
  ...
  $sqlz3 = "update movimientoudaf  set id_estado = 1  where  Id_expedienteudaf = '$ee'";
...
if( $stmt === false) {
  ...
  $sqlz2 = "insert into movimientoudaf ( id_expedienteudaf,id_usuario, id_estado,id_dependencia,usuario_recibe,fecha_traslado,comentarios,id_recibido,tipoexpediente ) values ('$ee','$uen','2','$aa','$bb',GETDATE(),'$cc','20','2')";
...
//echo " Dato guardado "; 
  ...
  $sqlz3 = "update expediente_udaf set id_estado = '2'  where  Id_expedienteudaf = '$ee'";
sqlsrv_query($conn,$sqlz3 ) ; 
if( $stmt === false) {
    die( print_r( sqlsrv_errors(), true) );
}
