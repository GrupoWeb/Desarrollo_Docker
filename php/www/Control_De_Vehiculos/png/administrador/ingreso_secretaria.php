...
<form action="guardarsolicitud_secretaria.php" method="post" enctype="multipart/form-data" name="form1">
  
<header id="header" class="info">
<h2>Ingreso de Expedientes Secretaria </h2>

<p>
  <? include("consulta/fecha.php");  ?>
</p>
<p><img src="../logos_expe/mineco.png" width="176" height="82"></p>
</header>
