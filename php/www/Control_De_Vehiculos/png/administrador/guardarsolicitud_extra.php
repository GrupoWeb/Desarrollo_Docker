 ...
 <table width='350' border='0' align='center'	>
   ...
   $row= sqlsrv_query($conn,$query ) or die (sqlsrv_errors()); 
	...
	if (strlen($userfile)>0)
	{
	   ...
	   $sql ="insert into dbo.expediente (fecha_ingreso,comentario,id_usuario,id_empresa,id_dependencia,id_estado,id_documento,id_solicitud,folio,numerodenit,id_solicitante,id_ingreso,numero_resolucion,id_correlativoftp,id_recibido) 
	   values (GETDATE(), '$a','$b','$c','$d','1',' $doc','$g','$m','$ni','$uen','1','$propiedad','$idindex',20)";
...
<center><h1 estilo1><img src='images/check.png' height='100' width='100' alt='Botón' /> <p id='texto'> Su expediente a sido guardado satisfactorio EXTRAORDINARIO, su correlativo es  : </p>
