...
<br></br>
 <table width='350' border='0' align='center'	>
   ...
   <tr>
	...
	$query =  "insert into documento (direccion,Descripcion,id_usuario,fechaad,nombrearchivo) values ('$tmpfile','$a','$b',GETDATE(),'$nombre_archivo')";
...
//	echo "id_documento", $doc, "<br>";
		...
		$idindex = 'MI'."-".$idcorr."-".$año; 
				   
				
        //fin de toma de correlativo las letas SG y el año son automaticas 
		
				
	   $sql ="insert into dbo.expediente (fecha_ingreso,comentario,id_usuario,id_empresa,id_dependencia,id_estado,id_documento,id_solicitud,folio,numerodenit,id_solicitante,id_ingreso,id_correlativoftp) 
	   values (GETDATE(), '$a','$b','$c','$d','1',' $doc','$g','$m','$ni','$uen','5','$idindex' )";
...
<p id='texto> MI-$expd-$año  </h1></center>
...
//envio de correo 
 ...
 $apellido=     $fila['apellido'];
    ...
    $para = $cor; 
     $nombre = $nom;
	 $asunto = "Revisar expediente No.  MI-$expd-$año";
	 $mensaje = "Estimado $nombr $ape
	
	Gusto en saludarle,
	Por este medio se le informa que se le a sigo asignado el expediente No. MI-$expd-$año para su revisión. 
