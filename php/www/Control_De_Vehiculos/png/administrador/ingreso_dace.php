...
<form action="guardarsolicitud_dace.php" method="post" enctype="multipart/form-data" name="form1">
  
<header id="header" class="info">
<h2>Ingreso de Expedientes DACE </h2>

<p>
  <? include("consulta/fecha.php");  ?>
</p>
<p><img src="../logos_expe/dace.jpg" width="89" height="85"></p>
</header>
