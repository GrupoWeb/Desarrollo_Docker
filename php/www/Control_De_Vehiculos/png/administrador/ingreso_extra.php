...
<form action="guardarsolicitud_extra.php" method="post" enctype="multipart/form-data" name="form1">
  
<header id="header" class="info">
<h2>Ingreso de Expedientes Registro Mercantil </h2>

<p>
  <? include("consulta/fecha.php");  ?>
</p>
<img src="../logos_expe/Registro_Mercantil.jpg" width="76" height="76"></header>
...
?>
  ...
  <br>
  <br>
  Nombre de la Marca:<span class="notranslate      ">
  <input type="text" name="fo22" size="10"  value="" >
  </span></label>
  <p><span class="notranslate      "><span class="desc"><strong>N&uacute;mero de folio: </strong>
        <input type="text" name="fo2" size="10"  value="" >
  </span></span></p>
  </div >
...
<label class="desc" id="title6" for="Field6">
  ...
  <p><span class="notranslate      "><span class="desc"><strong>Numero de Propiedad Industriall: </strong>
        <input type="text" name="prp" size="10"  value="" >
  </span></span></p>
...
class="notranslate      ">Descripcion de Solicitud
  <div>
<textarea id="Descripcion_de_solicitud" name="comentario" class="field textarea medium" spellcheck="true" rows="10" cols="50" tabindex="6" onKeyUp="validateRange(12, 'word');"  ></textarea>
