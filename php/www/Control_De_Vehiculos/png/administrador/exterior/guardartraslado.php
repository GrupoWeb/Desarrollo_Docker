...
if( $stmt === false) {
  ...
  $sqlz2 = "insert into movimiento ( id_expediente,id_usuario, id_estado,id_dependencia,usuario_recibe,fecha_traslado,comentarios,id_tipodocumento ) values ('$ee','$uen','18','$aa','$bb',GETDATE(),'$cc','$sectorexp')";
