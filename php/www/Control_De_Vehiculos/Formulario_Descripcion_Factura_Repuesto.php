...
<form action = "PHP/Ingresa_Factura_Reparacion.php" />
</head>

<body style="font-family: 'Segoe UI';">
<h1 align = "center">Ingreso de facturo por Reparacion de Vehiculo</h1>
<div align="right">
	<label>No. Factora</label>
...
<div align="center">
	...
	<input type = "hidden" name = "idReparacion" id = "idReparacion" value = "<? echo $_REQUEST['p']; ?>"/>
</div>
<table align = "center">
	<thead>
		<tr>
