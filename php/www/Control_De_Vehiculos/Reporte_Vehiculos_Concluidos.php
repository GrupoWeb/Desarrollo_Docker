...
.th{
 ...
 <table id="dt" class="table table-striped table-bordered nowrap "  width="50%">
    ...
    <tr class="t">
                ...
                <th class="th">Cantidad Solicitudes</th>
...
";              
 ...
 echo "<br><center style='font-size:1.5em'>  VEHÍCULOS CONCLUIDOS</center>";
...
$result = sqlsrv_query($conn, $query2);
	...
	if($result)
	{
		...
		for($j = 0; $Vehiculos[$j]; $j++)
		{
			...
			FROM 
				[dbo].[tbVehiculo] AS [vh]
				INNER JOIN [dbo].[tbKM_Vehiculo_Soloicitud] AS [kvs] ON [kvs].[idVehiculo] = [vh].[idVehiculo]
			WHERE 
