...
.th{
 ...
 <table id="dt" class="table table-striped table-bordered nowrap "  width="50%">
    ...
    <tr class="t">
                ...
                <th class="th">Cantidad Reparación</th>
...
";              
 ...
 echo "<br><center style='font-size:1.5em'>  VEHÍCULOS EN REPARACIÓN</center>";
...
$result = sqlsrv_query($conn, $query2);
	...
	if($result)
	{
		...
		for($j = 0; $Vehiculos[$j]; $j++)
		{
			...
			FROM 
				[dbo].[tbVehiculo] AS [vh]
				INNER JOIN [dbo].[tbKM_Vehiculo_Reparacion] AS [kvr] ON [kvr].[idVehiculo] = [vh].[idVehiculo]
			WHERE 
				[kvr].[idVehiculo] = " . $Vehiculos[$j]['idVehiculo'];
