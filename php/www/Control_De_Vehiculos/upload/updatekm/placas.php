        ...
        <div class="card-body">
            <form id="dataHistory">
                <div class="container">
                    <div class="row">
                        <div class='col-sm-6' >
                            <p>Vehiculo Asignado: <select name="PlacaId"  style="text-align: center" id="PlacaId"  class="form-control"></select></p>        
                        </div>
                        <div class='col-sm-6' >
...
$(document).ready(function(){
    ...
    llenarCombos('model/DataPlacas.php',"#PlacaId");
    ...
    $('#cambiar').click(function(){
        UpdatePlaca('model/updatePlaca.php','#dataHistory');
    })
