...
<div >
<table  id = "leTable" class="table table-responsive" style="font-size:11px;">
	<tr>
	...
	<tr>
		...
		<td>
			<u><label id = "FechaSolicitud">'; $template .= $row['dFecha_Solicitud']->format("d-m-Y"); $template .='</label></u>
		</td>
		<br/>
		<td> 
		...
		<td>
			<u><label id = "HoraSolicitud">'; $template .= $row['hHora_Solicitud']->format("H:i"); $template .='</label></u>
		</td>
	</tr>
	<tr>
		<td>
	...
	<tr>
		...
		<td>
		<input type = "checkbox" id = "CMenor" '; $template .= $row['idTipo_Comision'] == 1 ? "checked" : false; $template .=' readonly/>
		</td>
			
		<td ><label>Comision Mayor</label>
		</td>
		<td>
		<input type = "checkbox" id = "CMayor"  '; $template .= $row['idTipo_Comision'] == 2 ? "checked" : false; $template .=' readonly/>
		</td>
	</tr>
...
<tr>
		...
		<td>
			<u><label>'; $template .= $row['KM_Regreso']; $template .=' KM.</label></u>
		</td>
	</tr>
	<tr>
		<td>
		...
		<td>
			<u><label>'; $template .= $row['KM_Regreso'] - $row['KM_Salida'] ; $template .=' KM.</label></u>
		</td>
	</tr>';
...
$template .= '	<tr>
	...
	<tr>
		...
		<td>
			<u><label id = "FechaSolicitud">'; $template .= $row['FechaFinalReal']->format("d-m-Y"); $template .='</label></u>
		</td>
		...
		<td>
			<u><label id = "HoraSolicitud">'; $template .= $row['HoraFinalReal']->format("H:i"); $template .='</label></u>
		</td>
</tr>
	<tr>
	<td> 
	...
	<tr>
		...
		<td>
			<u><label>'; $template .= $row['strAutorizador']; $template .='</label></u>
		</td>
		<td>
