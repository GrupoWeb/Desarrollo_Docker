<?php
	...
	$query = "SELECT 
		...
		FROM tbSolicitud_Vehiculo as sl 
		inner join tbTipo_Solicitud as ts 
		on ts.idTipo_Solicitud = sl.idTipo_Solicitud 
		inner join tbTipo_Comision as tc 
		on tc.idTipo_Comision = sl.idTipo_Comision 
		INNER JOIN tbMotivos motivo
    		ON   motivo.idsolicitud = sl.idSolicitud_Vehiculo 
		WHERE sl.idSolicitud_Vehiculo =  $idSolicitud";
