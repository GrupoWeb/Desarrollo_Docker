...
.Estilo5 {font-size: medium}
	...
	<form>
		<div  id='cssmenu'>
			<ul>
				<li><h3>Consultar Solicitudes</h3></li>
				...
				<!--
				<li><h3>Consultar de Reabastecimiento de Combustible</h3></li>
				<li><a id = "Tabla_Confirmacion_Vales">Confirmar Vales para Combustible</a></li>
				<li><a id = "Tabla_Retorno_Vales">Retorno de Reabastecimiento de Combustible</a></li>-->
				<?php
				  $sql="
				  select 
					enlace.id_link, 
