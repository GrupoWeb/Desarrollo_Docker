...
<section class="sidebar" style="width: 100%;">
    ...
    <ul class="sidebar-menu">
        ...
        <li>
            <h5>Servicios para Vehiculos</h5>
        </li>
        <li class="treeview">
            <a style="word-wrap: break-word;" id="Formulario_Ingreso_Servicio">Enviar a Mantenimiento</a>
        </li>
        <li class="treeview">
            <a id="Formulario_Ingreso_Reparacion">Enviar automovil a Reparación</a>
        </li>
        <li class="treeview">
            <a id="Tabla_Vehiculos_Mantenimiento">Retornado de Mantenimiento</a>
        </li>
        <li class="treeview">
            <a id="Tabla_Vehiculos_Reparacion">Retornado de Reparación</a>
        </li>
