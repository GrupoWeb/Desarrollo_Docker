<body>
	<form action="PHP/Ingreso_Solicitud.php" method="POST" enctype="multipart/form-data" style = "pisition: relative;  width:100%;  display: inline-block;">
<div id="container" class="ltr" style="border: solid 0.5px; margin-left: -10px; background:#FFFFFF; width:900px;">
...
<h2>Solicitud de Vehiculos</h2></td><td width="13%"><label style="font-size:15px;"><?php date_default_timezone_set("America/Guatemala"); echo date("d-m-Y"); ?></label></td></tr></table>
			...
			<table width="924">
              <tr>
                ...
                <td width="244" id = "Solicitante"></td>
                ...
                <td width="376" id = "Dependencia" >Informatica</td>
              </tr>
			  ...
			  <table>
				...
				<td>
                  ...
                  <input type = "button" id= "agregarCampo" class="btn btn-info" value = "Agregar Direccion"/>
				  <label>&nbsp;&nbsp;&nbsp;&nbsp;</label>
              ...
              <tr>
                <td><input name="submit" type = "submit" value = "Enviar Solicitud"/>
                </td>
              </tr>
            </table>
...

{
	...
	<script>	
		...
		$.ajax({
			url: 'PHP/Carga_Solicitud_Vehiculos.php',
			async: false,
			success: function(data)
			{
				data = JSON.parse(data);
				$("#Solicitante").empty();
				$("#Solicitante").append(data['strNombre_Solicitante']);
			}
		});
