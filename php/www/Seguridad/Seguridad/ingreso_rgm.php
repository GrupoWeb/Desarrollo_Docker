...
<form action="guardarsolicitud_rmg.php" method="post" enctype="multipart/form-data" name="form1">
  
<header id="header" class="info">
<h2>Ingreso de Expedientes </h2>
...
<?php 
		$sql="select Nombre_sys, id_sistema from Tsistema where estado = 1";
		$stmt=sqlsrv_query($conn,$sql);
