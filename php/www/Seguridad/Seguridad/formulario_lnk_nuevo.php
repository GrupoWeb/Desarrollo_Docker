    ...
    <div class="col-md-6">
         <div class="row myborder">
             <h4 style="color: #0d0d0d; margin: initial; margin-bottom: 10px;">Nuevo permiso</h4><hr>
				<form action="php_fucntion/linkvldr.php" method="POST">
...
<br>
<br>
<select name="tlk" class="selectpicker" data-live-search="true" required>
				 <option ></option>
                <?php 
...
<br>
		   <div class="input-group margin-bottom-20">
                ...
                <input size="60" maxlength="255" class="form-control" placeholder="Carpeta/Archivo Ejemplo: Seguridad/index.php" name="nombrea"  type="text" required></div>
				<div class="input-group margin-bottom-20">
                <span class="input-group-addon"><i ></i></span>
                <input size="60" maxlength="255" class="form-control" placeholder="Nombre que tendra dentro del menu" name="nombreb"  type="text" required></div>
