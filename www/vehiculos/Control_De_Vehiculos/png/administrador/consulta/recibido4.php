...
sqlsrv_free_stmt( $stmt);	
 ...
 while($row) 
  ...
  $sqlls=" update dbo.movimiento set id_recibido = 19  where  id_estado= 17 and usuario_recibe='$uen' and id_expediente =  $k ";
...
$Hora= date('i:s');
	...
	ha recibido el expediente NO. SG-$cor-$año 
...
//	$headers .= "To: $para; \r\n subject:$asunto \r\n";
  ...
  <SCRIPT LANGUAGE="javascript"> 
    alert("Expediente Recibido Fisicamente");
    document.location=("./archivados.php");
</SCRIPT>              