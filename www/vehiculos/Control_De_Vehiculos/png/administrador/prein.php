...
<h2>EXPEDIENTES PENDIENTES DE INGRESO </h2>
</header>
...
<?
	    ...
	    $sql = " select id_expediente,id_empresa, id_solicitud,id_usuario, preingreso from expediente where preingreso='1'";
$stmt = sqlsrv_query( $conn, $sql );
...
echo "<td> <a href='actualizar_preingreso/versolicitud.php?ex=$t' >  <img src='lupas.png' width='24' height='22'> </td></a> </tr>";
}
