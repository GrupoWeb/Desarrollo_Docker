...
<li><a href="./menuscript/jQuery.htm">Menu opciones</a>
	<ul style="display: block;">
		...
		<li><? echo " <a href='../adjuntoudaf/adjunto.php?d=$k'>              "	?>Adjuntos</a></li>
		<li><? echo " <a href='../finalizadoudaf/finalizado.php?d=$k'>              "	?>Finalizar</a></li>
	</ul>
</li>      </td>
  </table>
...
on expe.Id_empresa = empt.id_empresa 
 where expe.Id_expedienteudaf = '$cor'" ;
$stmt = sqlsrv_query( $conn, $sql );
...
<?
	    ...
	    $sql = "select tipdoc.nombre_documento, mov.fecha_traslado, us.nombre, us.apellido, usua.nombre as d, usua.apellido as p,  mov.comentarios from movimientoudaf as mov inner join usuario as us
