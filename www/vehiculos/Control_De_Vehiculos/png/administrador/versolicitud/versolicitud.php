 ...
 while($row) 
  ...
  $k=$cor;
	 ...
	 sur.nombre as nom, sur.apellido as apell, sur.correo as corr, depen.Nombre_dependencia 
	  ...
	  expt.Id_usuario = sur.id_usuario inner join dependencia as depen on depen.id_dependencia = sur.id_dependencia   where expt.Id_expediente = '$cor'	";
...
<li><a href="./menuscript/jQuery.htm">Menu opciones</a>
	<ul style="display: block;">
		 ...
		 <div class="title"><li><span>Transfiere El Expediente a Otra Dependencia y Usuario</span><? echo " <a href='../traslados/traslados.php?d=$k'>          "	?>  Trasferir</a></li> </div>

	<div class="title"><li><span>Agrega Observaciones al Expedienes</span><? echo " <a href='../observaciones/observaciones.php?d=$k'>  "?>Observaciones</a></li> </div>

		<div class="title"><li><span>Agrega Adjutnos al Expediente</span><? echo " <a href='../adjunto/adjunto.php?d=$k'>              "	?>Adjuntos</a></li> </div>

	 <div class="title"><li><span>Finaliza el Expedente</span><? echo " <a href='../finalizado/finalizado.php?d=$k'>              "	?>Finalizar</a></li></div>
...
<?
	    ...
	    $sql = "select mov.fecha_traslado, us.nombre, us.apellido, usua.nombre as d, usua.apellido as p,  mov.comentarios from movimiento as mov inner join usuario as us
