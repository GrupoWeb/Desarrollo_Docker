  ...
  <div>
    <table align="lefth" width="57%"    >
       ...
       <?
	    ...
	    $sql = "select expe.Fecha_ingreso, soli.Nombre_solicitud, us.nombre, us.apellido, usp.nombre as nom ,usp.apellido as ape, dep.Nombre_dependencia, expe.Comentario from expediente as expe inner join usuario as us 
...
on soli.id_solicitud = expe.id_solicitud inner join usuario as usp on usp.id_usuario = expe.id_solicitante
...
<th class="Estilo5">ver   </th>
	    ...
	    $sql = "select ar.fechaad, uss.usuario,ar.nombrearchivo, ar.direccion, ar.descripcion from documento as ar inner join expediente as expe
