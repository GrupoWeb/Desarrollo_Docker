...
<body>
<table width="95%" height="524" align="center">
  <tr>
    <td height="480"><table width="750"   align="center">
  <tr>
  ...
  <tr>
   ...
   <tr>
    ...
    <td align="justify">  <span style="font-size:15px;color:black; font-family: Segoe UI">  "Ser una Unidad de apoyo a todas las unidades administrativas del Despacho del Ministro de Economía, vanguardista en el uso de métodos de trabajo y de comunicación moderna, así como ser un modelo estatal de desempeño en la prestación de servicios, respondiendo a las expectativas de los usuarios internos y externos.</span>
	</td>
