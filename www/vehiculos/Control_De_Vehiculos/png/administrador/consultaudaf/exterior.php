...
<?
	...
	on us.id_usuario = mov.id_usuario inner join usuario as usua on usua.id_usuario = mov.usuario_recibe inner join estado as stp on mov.id_recibido = stp.Id_estado
		where  mov.id_estado=18 and mov.usuario_recibe='$uen' order by mov.id_expediente desc";
$stmt = sqlsrv_query( $conn, $sql );
if( $stmt === false) {
    die( print_r( sqlsrv_errors(), true) );
...
echo "<td> <a href='../versolicitud/versolicitud5.php?ex=$t' >  <img src='images/lupas.png' width='24' height='22'> </td>";
echo "<td><a href='recibido5.php?ex=$t' >  <img src='images/$thr' width='24' height='22'> </td>";
