...
include('../../conexion/conexion.php');
 ...
 if ($si == 1)
{ 
 $sqlz3 = "insert into dbo.empresa (nombre_empresa, nits,activo,id_sector) values ('$cor' ,'$nit','1','$secem')";
sqlsrv_query($conn,$sqlz3 ) ; 
if( $stmt === false) {
    die( print_r( sqlsrv_errors(), true) );
}

echo "Empresa ingresa.";
}

else 

{
echo "Empresa no ingresada";
}
