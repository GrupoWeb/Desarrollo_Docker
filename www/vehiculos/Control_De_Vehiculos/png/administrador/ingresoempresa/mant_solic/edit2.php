...
$sql = "select nombre_solicitud from dbo.solicitud where id_solicitud='$cor' and activo = 1";
...
{ 
 $sqlz3 = "update 
dbo.solicitud  set nombre_solicitud= '$nombre' where id_solicitud = '$cor'";
