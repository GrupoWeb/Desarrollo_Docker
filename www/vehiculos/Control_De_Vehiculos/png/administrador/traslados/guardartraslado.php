...
if( $stmt === false) {
  ...
  $sqlz2 = "insert into movimiento ( id_expediente,id_usuario, id_estado,id_dependencia,usuario_recibe,fecha_traslado,comentarios,id_tipodocumento, id_recibido ) values ('$ee','$uen','2','$aa','$bb',GETDATE(),'$cc','$sectorexp','20')";
