...
<head>
  ...
  <style>
button.accordion {
    background-color: #00425C; /*Es el color Inactivo*/
    color: #FFFFFF;
    cursor: pointer;
    padding: 18px;
    width: 100%;
...
button.accordion.active, button.accordion:hover {
    background-color: #0093CD; /*Es el color cuando se activa el boton*/
}
...
<button type="button" class="btn btn-primary btn-sm btn-block">Button 1</button>
    ...
    <div  class="col-sm-9">
      <div id='capa'>
          <div class="right">
        <div  class="dropdown">
  <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown"><?php echo 'Bienvenido '.utf8_decode($row['nombre']); ?>
